...
- Сложность эффективного распараллеливания программы
...
- prometheus — система сборки и хранения метрик
- opentelemetry-collector/jaeger — серверная обработка трейсов
